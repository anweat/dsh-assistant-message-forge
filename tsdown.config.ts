/**
 * tsdown build for dsh-assistant-message-forge: the single browser client
 * bundle (lib/client.js, CJS closure factory) registered under the
 * package-name id 'dsh-assistant-message-forge'. The host half is built by tsc
 * (lib/index.js keeps its @deepseek-ai/* imports external; they resolve from
 * the profile install).
 *
...
const PLUGIN_ID = 'dsh-assistant-message-forge'
